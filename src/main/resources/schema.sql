...
-- soft delete
ALTER TABLE surface_types ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE users ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE courts ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE reservations ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
